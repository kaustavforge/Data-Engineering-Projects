...
def orchestrate():
    ...
    @task
    def ingest_cdc():
        # Keep the Databricks SDK out of DAG parse time.  Airflow imports DAGs
        # in a short-lived process with a strict timeout; the SDK is only
        # needed when this task actually runs.
        from databricks.sdk import WorkspaceClient
        from databricks.sdk.service.jobs import RunLifeCycleState, RunResultState

        required = ("DATABRICKS_HOST", "DATABRICKS_TOKEN", "DATABRICKS_JOB_ID")
